...
public class CustomerServiceImpl implements CustomerService {
    ...
    public List<CustomerModel> findByFirstandLastNameIgnoreCase(String firstName, String lastName) {
        List<CustomerModel> customers=customerRepository.findByFirstandLastNameIgnoreCase(firstName,lastName);
        return customers;
    }

    @Override
    public List<CustomerModel> findByFirstorLastNameIgnoreCase(String firstName, String lastName) {
        List<CustomerModel> customers=customerRepository.findByFirstorLastNameIgnoreCase(firstName,lastName);
        return customers;
    }
