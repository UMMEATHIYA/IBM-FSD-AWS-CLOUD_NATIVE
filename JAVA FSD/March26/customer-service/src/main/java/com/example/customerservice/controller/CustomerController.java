...
public class CustomerController {
    ...
    public ResponseEntity<List<CustomerResponseModel>> getByfirstandLastName(@PathVariable("firstName") String firstName,@PathVariable("lastName") String lastName)
    {
        List<CustomerModel> list=customerService.findByFirstandLastNameIgnoreCase(firstName,lastName);
        List<CustomerResponseModel> responses=new ArrayList<CustomerResponseModel>();
        Iterator<CustomerModel> i=list.iterator();
        while(i.hasNext())
        {
    ...
    @GetMapping("/customers/nameor/{firstName}/{lastName}")
    ...
    {
        List<CustomerModel> list=customerService.findByFirstorLastNameIgnoreCase(firstName,lastName);
        List<CustomerResponseModel> responses=new ArrayList<CustomerResponseModel>();
        Iterator<CustomerModel> i=list.iterator();
        while(i.hasNext())
        {
